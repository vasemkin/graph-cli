...
export class ExampleEntity extends Entity {
  constructor(id: string) {
    ...
    this.set("requiredBoolean", Value.fromBoolean(false));
    this.set("requiredBooleanList", Value.fromBooleanArray(new Array(0)));
    this.set("requiredString", Value.fromString(""));
    this.set("requiredStringList", Value.fromStringArray(new Array(0)));
    this.set("requiredBytes", Value.fromBytes(Bytes.empty()));
    this.set("requiredBytesList", Value.fromBytesArray(new Array(0)));
    this.set("requiredInt", Value.fromI32(0));
    this.set("requiredIntList", Value.fromI32Array(new Array(0)));
    this.set("requiredBigInt", Value.fromBigInt(BigInt.zero()));
    this.set("requiredBigIntList", Value.fromBigIntArray(new Array(0)));
    this.set("requiredReference", Value.fromString(""));
    this.set("requiredReferenceList", Value.fromStringArray(new Array(0)));
  }
